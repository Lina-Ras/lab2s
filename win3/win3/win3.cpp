...
INT_PTR CALLBACK ListEdit(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
    {
        ...
        case IDC_PLUS:
        {
            ...
            auto length1 = SendMessage(Edit1, WM_GETTEXTLENGTH, NULL, NULL);
            auto buffer1 = new wchar_t[length1 + 1];
            SendMessage(Edit1, WM_GETTEXT, length1 + 1, (LPARAM)buffer1);
            SendMessage(ListBox, LB_ADDSTRING, 0,
                (LPARAM)(LPSTR)buffer1);
